...
plot_save_path = os.getcwd() + "/MSADA/MSADA-DSADS-SameUser-DifferentPosition-Augmented-10/"+folder_name+"/Target-Position-"+position_array[data_source["target"]]+"/User "+ str(selected_user)+"/"

pretrain_path = "/notebooks/Downloads/ISWC/Debug-Pretraining/Pre-trained/DSADS-10-SameUser-DifferentPosition-Augmentation/"+folder_name+"/Target-Position-"+position_array[data_source["target"]]+"/User "+ str(selected_user)+"/"
...
experiment_summery_file = os.getcwd() + "/MSADA/MSADA-DSADS-SameUser-DifferentPosition-Augmented-10/"
file1 = open(experiment_summery_file+"MSADA-DSADS-SameUser-DifferentPosition-Augmented-10.txt", "a")
