...
plot_save_path = os.getcwd() + "/MSADA/OPP-SameUser-DifferentPosition-Augmented/"+folder_name+"/Target-Position-"+position_array[data_source["target"]]+"/User "+ str(selected_user)+"/"

pretrain_path = "/notebooks/Downloads/ISWC/Debug-Pretraining/Pre-trained/OPP-SameUser-DifferentPosition-Augmented/"+folder_name+"/Target-Position-"+position_array[data_source["target"]]+"/User "+ str(selected_user)+"/"
...
experiment_summery_file = os.getcwd() + "/MSADA/OPP-SameUser-DifferentPosition-Augmented/"
file1 = open(experiment_summery_file+"MSADA-OPP-SameUser-DifferentPosition-Augmented.txt", "a")
