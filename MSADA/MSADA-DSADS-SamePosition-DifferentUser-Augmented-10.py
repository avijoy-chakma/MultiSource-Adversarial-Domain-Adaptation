...
common_path = "DSADS-SamePosition-DifferentUser-augmented-10/"+folder_name+"/Position-"+position_array[position]+user_combination
...
experiment_summery_file = os.getcwd() + "/MSADA/MSADA-DSADS-SamePosition-DifferentUser-Augmented-10/"
file1 = open(experiment_summery_file+"MSADA-DSADS-SamePosition-DifferentUser-Augmented-10.txt", "a")
