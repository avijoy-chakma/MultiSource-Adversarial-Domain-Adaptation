...
save_path = "/Pre-trained/PAMAP-SamePosition-DifferentUser-Augmented-11/"+folder_name+"/Position-"+position_array[position]+user_combination
...
experiment_summery_file = os.getcwd() + "/Pre-trained/PAMAP-SamePosition-DifferentUser-Augmented-11/"
file1 = open(experiment_summery_file+"PAMAP-SamePosition-DifferentUser-Augmented-11-verify.txt", "a")
