...
directory = "POC"
main_folder = "OPP-90-SamePosition-DifferentUser-Augmentation"
...
# Save everything under Pretraining folder. Shell script creates "os.getcwd() + "/Pre-trained/"+main_folder" folder
user_combination = "/S1: "+str(source1_user)+" S2: "+str(source2_user)+" Target "+ str(target_user)+"/"
save_path = os.getcwd() + "/Pre-trained/"+main_folder+"/"+dataset_settings+"/Position-"+position_array[position]+user_combination
...
#     plot(save_path, 'A', win_size, overlap, target_user, acc_test_A, plot_common_title, save_path)
#     plot(save_path, 'B', win_size, overlap, target_user, acc_test_A, plot_common_title, save_path)
