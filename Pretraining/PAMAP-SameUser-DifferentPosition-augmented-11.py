...
save_path = "/Pre-trained/PAMAP-SameUser-DifferentPosition-Augmented-11/"+folder_name+"/Target-Position-"+position_array[data_source["target"]]+"/User "+ str(selected_user)+"/"
...
# In[13]:
experiment_summery_file = os.getcwd() + "/Pre-trained/PAMAP-SameUser-DifferentPosition-Augmented-11/"
file1 = open(experiment_summery_file+"PAMAP-SameUser-DifferentPosition-Augmented-11-verify.txt", "a")
...
def evaluation(e):
    ...
    plot(plot_save_path, 'A', win_size, overlap, selected_user, acc_test_A, plot_common_title, plot_save_path)
    plot(plot_save_path, 'B', win_size, overlap, selected_user, acc_test_A, plot_common_title, plot_save_path)
